...
Простой бот работающий с API Яндекс.Практикум, весь функционал это отображать статсу проверки кода ревью вашей работы.
...
```bash
git clone https://github.com/qwerty161crew/homework_bot.git
```

или

```bash
git clone git@github.com:qwerty161crew/homework_bot.git
```
...
Автор: [Матвеев Алексей](https://github.com/qwerty161crew) :+1:
